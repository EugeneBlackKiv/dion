export class FaqSection extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .icon_container{
          ...
          border-radius: 32px;
          position: relative;
          background: var(--state-layers-primary-primary-opa-xs, rgba(128, 91, 255, 0.08));
        }
        .icon_position{
          position: absolute;
          top: 50%;
        ...
        .answer{
          ...
          line-height: var(--line-height-body-p1, 24px); /* 150% */
        ...
        <div class="faq_group">
          <div class="row_one">
            <div class="card card_1">
              ...
              <div class="answer">
                  Unlike typical sites that just show you a list, this AI broker analyzes multiple sources and filters everything based on your needs — price, comfort, flexibility, and more — then shows you only the smartest options.
              </div>
            </div>
            <div class="card card_2">
              <div class="card_header">
                <div class="icon_container">
                  <svg class="icon_position animatie_2" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M43.5 23C43.5 22.7239 43.2761 22.5 43 22.5C42.7239 22.5 42.5 22.7239 42.5 23H43H43.5ZM20.3333 3C20.3333 4.47276 21.5272 5.66667 23 5.66667C24.4728 5.66667 25.6667 4.47276 25.6667 3C25.6667 1.52724 24.4728 0.333333 23 0.333333C21.5272 0.333333 20.3333 1.52724 20.3333 3ZM43 23H42.5C42.5 33.7696 33.7696 42.5 23 42.5V43V43.5C34.3218 43.5 43.5 34.3218 43.5 23H43ZM23 43V42.5C12.2304 42.5 3.5 33.7696 3.5 23H3H2.5C2.5 34.3218 11.6782 43.5 23 43.5V43ZM3 23H3.5C3.5 12.2304 12.2304 3.5 23 3.5V3V2.5C11.6782 2.5 2.5 11.6782 2.5 23H3Z" fill="#805BFF"/>
                  </svg>
              ...
              <div class="answer">
                  We search across dozens of airline websites, travel agencies, and booking platforms in real time — so you get the most complete and competitive offers in one place.
              </div>
            </div>
            <div class="card card_3">
              <div class="card_header">
                <div class="icon_container">
                  <svg class="icon_position animatie_3" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M43.5 23C43.5 22.7239 43.2761 22.5 43 22.5C42.7239 22.5 42.5 22.7239 42.5 23H43H43.5ZM20.3333 3C20.3333 4.47276 21.5272 5.66667 23 5.66667C24.4728 5.66667 25.6667 4.47276 25.6667 3C25.6667 1.52724 24.4728 0.333333 23 0.333333C21.5272 0.333333 20.3333 1.52724 20.3333 3ZM43 23H42.5C42.5 33.7696 33.7696 42.5 23 42.5V43V43.5C34.3218 43.5 43.5 34.3218 43.5 23H43ZM23 43V42.5C12.2304 42.5 3.5 33.7696 3.5 23H3H2.5C2.5 34.3218 11.6782 43.5 23 43.5V43ZM3 23H3.5C3.5 12.2304 12.2304 3.5 23 3.5V3V2.5C11.6782 2.5 2.5 11.6782 2.5 23H3Z" fill="#805BFF"/>
                  </svg>
              ...
              <div class="answer">
                  Yes — using the assistant and searching flights is 100% free. We may earn a small referral fee from some booking partners, but it never affects your price.
              </div>
            </div>
          </div>
          <div class="row_one">
            <div class="card card_4">
              ...
              <div class="answer">
                  No — after we find the best flight for you, we’ll redirect you to the most reliable booking partner (like the airline or agency) to complete your purchase.
              </div>
            </div>
            <div class="card card_5">
              ...
              <div class="answer">
                  Absolutely. Just tell the assistant that you prefer flexible fares, and it will prioritize options you can change or cancel without penalty.
              </div>
            </div>
            <div class="card card_6">
              ...
              <div class="answer">
                  You can include that in your preferences when starting the search. The AI will consider that info to suggest flights that better suit your situation.
              </div>
            </div>
          </div>
        </div>
  ...
  connectedCallback() {
    ...
    const elementsTrig = this.shadowRoot.querySelector(".main_title"); //➡️ Găsește elementul .un_patrat în interiorul DOM-ului Shadow. Acesta este elementul pe care doriți să îl animați.
    ...
    let start = 3000; // ➡️start: când începe animația, pe baza poziției verticale a elementului.
    let end = 3220;// ➡️end: poziția de defilare hardcoded în care se termină animația.
    let elementNume = ".main_title";//➡️ elementNume: Selector CSS pentru elementul care urmează să fie animat.
